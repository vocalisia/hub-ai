...
const i18n: Record<string, Record<string, string>> = {
  fr: {
    ...
    subtitle: "Obtenez les réactions d'acheteurs français simulés en quelques minutes. Remplacez les cycles d'etude lourds par une simulation IA precise basee sur les donnees INSEE.",
    ...
    placeholder_audience: 'Ex: Dirigeants PME 10-50 salariés, secteur IT, priorites annuelles...',
  ...
  en: {
    ...
    subtitle: 'Get reactions from simulated French buyers in minutes. Replace long research cycles with precise AI simulation based on INSEE data.',
    ...
    placeholder_audience: 'E.g: SME owners 10-50 employees, IT sector, annual planning priorities...',
    label_sector: 'Sector',
  ...
  de: {
    ...
    subtitle: 'Erhalten Sie Reaktionen simulierter französischer Käufer in Minuten. Ersetzen Sie lange Forschungszyklen durch praezise KI-Simulation basierend auf INSEE-Daten.',
  ...
  it: {
    ...
    subtitle: 'Ottieni le reazioni di acquirenti francesi simulati in pochi minuti. Sostituisci cicli di ricerca lunghi con simulazioni IA precise basate sui dati INSEE.',
