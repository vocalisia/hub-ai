---
title: "n8n self hosted + agent IA : stack technique de reference"
...
readTime: 10
excerpt: "Assembler n8n self hosted, LLM, base vectorielle et supervision pour creer une stack agent IA exploitable."
schema:
  type: "Article"
...
> **En bref :** Assembler n8n self hosted, LLM, base vectorielle et supervision pour creer une stack agent IA exploitable. Ce guide relie n8n self hosted, architecture IA et adoption metier pour aider les dirigeants, RevOps et equipes operations a deployer sans perdre le controle.

# n8n self hosted + agent IA : stack technique de reference
...
Il faut documenter les prompts, les outils, les permissions, les tests et les criteres d'escalade. Le maillage avec [multi agent framework : orchestrer roles, memoire et outils](/fr/blog/multi-agent-framework-orchestration), [agent ia entreprise : guide complet pour deployer sans chaos](/fr/blog/agent-ia-entreprise-guide-2026), [n8n self hosted : architecture propre pour automatisation ia](/fr/blog/n8n-self-hosted-architecture-ia), [multi agent framework : comparatif production pour 2026](/fr/blog/multi-agent-framework-comparatif-production) aide aussi a maintenir une vision coherente du systeme.
